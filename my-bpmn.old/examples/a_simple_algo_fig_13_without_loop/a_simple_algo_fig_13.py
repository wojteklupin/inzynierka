...
[paral_join1_id, _] = bpmn_graph.add_parallel_gateway_to_diagram(process_id,
    gateway_name="Parallel join")

[exc_fork2_id, _] = bpmn_graph.add_exclusive_gateway_to_diagram(process_id,
                                    gateway_name="exclusive_gate_fork")
[accept_task_id, _] = bpmn_graph.add_task_to_diagram(process_id, task_name="Accept task")
...
[exc_join3_id, _] = bpmn_graph.add_exclusive_gateway_to_diagram(process_id,
                                    gateway_name="13")
[read_msg_id, _] = bpmn_graph.add_task_to_diagram(process_id, task_name="Read message")
[exc_fork3_id, _] = bpmn_graph.add_exclusive_gateway_to_diagram(process_id,
                                    gateway_name="15")
[logout_id, _] = bpmn_graph.add_task_to_diagram(process_id, task_name="Logout")
[end_id1, _] = bpmn_graph.add_end_event_to_diagram(process_id, end_event_name="end_event1")
...
bpmn_graph.add_sequence_flow_to_diagram(process_id, exc_join3_id, exc_fork3_id)
