...
[task2a_id, _] = bpmn_graph.add_task_to_diagram(process_id, task_name="Task 2a")
[task2b_id, _] = bpmn_graph.add_task_to_diagram(process_id, task_name="Task 2b")
[exc_join1_id, _] = bpmn_graph.add_exclusive_gateway_to_diagram(process_id,
    gateway_name="Excl join 1")
