...
[exc_fork2_id, _] = bpmn_graph.add_exclusive_gateway_to_diagram(process_id,
    gateway_name="Excl fork 2")
[exc_fork3_id, _] = bpmn_graph.add_exclusive_gateway_to_diagram(process_id,
    gateway_name="Excl fork 3")

[end_id1, _] = bpmn_graph.add_end_event_to_diagram(process_id, end_event_name="End1")
[end_id2, _] = bpmn_graph.add_end_event_to_diagram(process_id, end_event_name="End2")
[end_id3, _] = bpmn_graph.add_end_event_to_diagram(process_id, end_event_name="End3")
[end_id4, _] = bpmn_graph.add_end_event_to_diagram(process_id, end_event_name="End4")
[end_id5, _] = bpmn_graph.add_end_event_to_diagram(process_id, end_event_name="End5")
[end_id6, _] = bpmn_graph.add_end_event_to_diagram(process_id, end_event_name="End6")

bpmn_graph.add_sequence_flow_to_diagram(process_id, start_id, exc_fork1_id)
bpmn_graph.add_sequence_flow_to_diagram(process_id, exc_fork1_id, exc_fork2_id)
...
bpmn_graph.add_sequence_flow_to_diagram(process_id, exc_fork2_id, end_id3)
bpmn_graph.add_sequence_flow_to_diagram(process_id, exc_fork2_id, exc_fork3_id)
bpmn_graph.add_sequence_flow_to_diagram(process_id, exc_fork2_id, end_id4)
bpmn_graph.add_sequence_flow_to_diagram(process_id, exc_fork3_id, end_id5)
bpmn_graph.add_sequence_flow_to_diagram(process_id, exc_fork3_id, end_id6)
