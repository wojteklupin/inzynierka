...
bpmn_graph.create_new_diagram_graph(diagram_name="interleaving")
...
bpmn_graph.add_sequence_flow_to_diagram(process_id, exc_fork2_id, end_id2)
...
bpmn_graph.add_sequence_flow_to_diagram(process_id, exc_fork2_id, end_id5)
