...
[task1_id, _] = bpmn_graph.add_task_to_diagram(process_id, "", node_id="task1")
[bnd_id, _] = bpmn_graph.add_boundary_event_to_task(process_id, task1_id, "message")
[task2_id, _] = bpmn_graph.add_task_to_diagram(process_id, "", node_id="task2")
...
bpmn_graph.add_sequence_flow_to_diagram(process_id, bnd_id, task2_id)
